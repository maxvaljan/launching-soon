  ...
  return (
    <section className="py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-center mb-12 text-white">References</h2>
              ...
              <CardHeader className="flex flex-col flex-1">
                <div className="flex-1">
                  ...
                  <CardDescription className="text-gray-400 min-h-[3rem]">
                    {reportName === 'BMVI Report' &&
                      'Innovationsprogramm Logistik 2023: Government Report on the Future of Logistics in Germany'}
                    {reportName === 'Deloitte Analysis' &&
                      'Global Smart Last-Mile Logistics Outlook'}
                    {reportName === 'McKinsey Report' &&
