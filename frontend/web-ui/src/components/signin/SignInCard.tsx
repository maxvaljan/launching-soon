...
export const SignInCard = () => {
  ...
  return (
    <div className="w-full h-screen overflow-hidden grid md:grid-cols-2">
      {/* Left image column */}
      <div className="relative hidden md:block h-full bg-maxmove-800">
        <Image
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="text-right text-sm">
              <a
                ...
                className="text-maxmove-creme/80 hover:underline"
              >
