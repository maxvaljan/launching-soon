 ...
 *
 * All buttons in the application should use rounded-xl for consistent styling
 * This ensures UI consistency across the entire web app.
 *
 * When implementing custom buttons, please use:
 * - rounded-xl for standard buttons
 */
